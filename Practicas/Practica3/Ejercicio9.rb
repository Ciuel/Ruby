...
#Seguí el flujo de ejecución registrando la traza de impresiones que deja el programa,
# analizando por qué partes del código va pasando y justificando esos pasos.

#¿Qué pasaría si se permuta, dentro de fun3, el manejador de excepciones para RuntimeError y el manejador de excepciones genérico (el que tiene el rescue vacío)?
#¿El uso de retry afectaría el funcionamiento del programa si se mueve la línea x = 0
